    ...
    <View style={[tw`bg-white h-full`]}>
      ...
      <ScrollView style={tw``}>
        <View style={tw`w-10/12 mx-auto mt-3`}>
          <View style={tw`border-b-2 border-gray-200 pb-13 w-full`}>
          ...
          <View style={tw`mt-4 flex flex-col gap-5 border-b-2 border-gray-200 pb-8`}>
            <View style={tw`flex flex-row gap-3 items-center`}>
              ...
              <View>
                <Text style={[tw`text-lg`,{fontFamily:"MadimiOne"}]}>{project?.BasicDetail?.LevelExperience} Level</Text>
            ...
            <View style={tw`flex flex-row gap-3 items-center`}>
              ...
              <View>
                <Text style={[tw`text-lg`,{fontFamily:"MadimiOne"}]}>{project?.BasicDetail?.spanPeriod} Month</Text>
            ...
            <View style={tw`flex flex-row gap-3 items-center`}>
              ...
              <View>
                <Text style={[tw`text-lg`,{fontFamily:"MadimiOne"}]}>{project?.BasicDetail?.projectLength} Project</Text>
          ...
          <View style={tw`-ml-3`}>
            ...
            <TouchableOpacity onPress={()=>handleSavedProject(project?._id)}>
              <View style={tw`border-[3px] border-green-600 p-2 px-3 rounded-full font-bold flex flex-row justify-center items-center gap-3`}>
                ...
                <Text style={tw`font-bold`}>{isSaved ? 'Unsave Project' : 'Save Project'}</Text>
              </View>
            </TouchableOpacity>
